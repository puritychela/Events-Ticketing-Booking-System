...
(async function seed() {
    try {
        ...
        await db_1.default.delete(schema_1.supportTicket);
        await db_1.default.delete(schema_1.payment);
        await db_1.default.delete(schema_1.booking);
        await db_1.default.delete(schema_1.event);
        await db_1.default.delete(schema_1.venue);
        await db_1.default.delete(schema_1.user);
        // 1. Users
        const insertedUsers = await db_1.default
            ...
            .returning();
        // 2. Venues
        const insertedVenues = await db_1.default
            .insert(schema_1.venue)
            .values([
            {
            ...
            .returning();
        // 3. Events
        const insertedEvents = await db_1.default
            .insert(schema_1.event)
            .values([
            {
            ...
            .returning();
        // 4. Bookings
        const insertedBookings = await db_1.default
            .insert(schema_1.booking)
            .values([
            {
        ...
        // 6. Support Tickets
        await db_1.default.insert(schema_1.supportTicket).values([
            {
                userId: insertedUsers[0].userId,
